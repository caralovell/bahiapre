...
import totemMain from "@/assets/uno.png";
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-[1fr_auto] gap-6 items-center mb-8">
          <div>
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              Pantallas de papel electrónico para hoteles: ideales para señalética de habitaciones, reserva de salas de
              reuniones, directorios, menús del día y comunicación con el huésped, con bajo consumo y máxima
              visibilidad.
            </p>
